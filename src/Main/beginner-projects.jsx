...
import ColorChange from '../assets/ColorChange.png';
...
const BeginnerProjects = () => {
	...
	return (
		<Container initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
			...
			<Card>
					<Link
						githubLink='https://github.com/chandannath500/colorchange'
						externalLink='https://colorchangge.netlify.app/'
					/>
					<ImgContainer>
						<Img src={ColorChange} alt='todo-app' />
					</ImgContainer>
					<TextContainer>
						<Title>Color-Changer App</Title>
						<Explanation>Change color on clikck</Explanation>
						<Technology>
							<TechItems>
								<Hastag>#</Hastag>HTML
							</TechItems>
