			...
			<Content>
				<Intro>
					...
					<Title
						...
						Chandan <span> Nath</span>
					</Title>
					<SubTitle
						initial={{ x: -300, opacity: 0 }}
						animate={{ x: 0, opacity: 1 }}
						transition={{ duration: 1 }}>
						I'm an aspiring <span>MERN Stack Developer</span> 
					</SubTitle>
					<Description initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }}>
						{
							"I'm a self-taught web app developer, a computer software engineer by degree🎓 and an open-source enthusiast based in Rourkela City, Odisha. I like building and designing exceptional websites, applications. "
						}
					</Description>
				</Intro>
			</Content>
